#!/usr/bin/env python3
"""
Comprehensive monitoring for robust training - ensures 100% completion
"""
...
def get_robust_training_status():
    """Get comprehensive robust training status"""
    status = {
    ...
    try:
        ...
        status['training_running'] = 'python3 train_robust.py' in result.stdout
    except:
        pass
...
def print_robust_status():
    """Print formatted robust training status"""
    status = get_robust_training_status()
    
    print("🎨 ROBUST VIRTUAL TRY-ON MAKEUP TRAINING")
    print("=" * 60)
