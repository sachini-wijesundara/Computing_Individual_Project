...
const _products = <Map<String, dynamic>>[
  ...
  // ── Eyeliner ─────────────────────────────────────────────────────────────────
  {
    ...
    'reviews': 134,
    'colorHex': '#000000',
    'imagePath': 'assets/products/eye products/eyeliner/grip mechanical gel eyeliner.png',
    'imageUrl': '',
  ...
  },
  {
    ...
    'reviews': 221,
    'colorHex': '#000000',
    'imagePath': 'assets/products/eye products/eyeliner/grip precision felt water proof eye liner.png',
    'imageUrl': '',
  ...
  },
  {
    ...
    'reviews': 89,
    'colorHex': '#2C2C2C',
    'imagePath': 'assets/products/eye products/eyeliner/matee-matic.png',
    'imageUrl': '',
  ...
  },
  {
    ...
    'reviews': 67,
    'colorHex': '#1A1A1A',
    'imagePath': 'assets/products/eye products/eyeliner/new fail eye liner.png',
    'imageUrl': '',
  ...
  },
  {
    ...
    'reviews': 156,
    'colorHex': '#000000',
    'imagePath': 'assets/products/eye products/eyeliner/pro-last waterproof eye liner.png',
    'imageUrl': '',
  ...
  },
  {
    ...
    'reviews': 98,
    'colorHex': '#111111',
    'imagePath': 'assets/products/eye products/eyeliner/smoldering liner.png',
    'imageUrl': '',
  ...
  },
  {
    ...
    'reviews': 112,
    'colorHex': '#000000',
    'imagePath': 'assets/products/eye products/eyeliner/super slim liquid eye liner.png',
    'imageUrl': '',
  ...
  },
  {
    ...
    'reviews': 145,
    'colorHex': '#000000',
    'imagePath': 'assets/products/eye products/eyeliner/super star liner.png',
    'imageUrl': '',
  ...
  // ── Eyebrow ──────────────────────────────────────────────────────────────────
  {
    ...
    'reviews': 203,
    'colorHex': '#6B4226',
    'imagePath': 'assets/products/eye products/eyebrow/24hr brow lamination.png',
    'imageUrl': '',
  ...
  },
  {
    ...
    'reviews': 88,
    'colorHex': '#7A5C3C',
    'imagePath': 'assets/products/eye products/eyebrow/brow gless.png',
    'imageUrl': '',
  ...
  },
  {
    ...
    'reviews': 176,
    'colorHex': '#5C3D1E',
    'imagePath': 'assets/products/eye products/eyebrow/definer mechanical water proof eye brow pencil.png',
    'imageUrl': '',
  ...
  },
  {
    ...
    'reviews': 134,
    'colorHex': '#6B4C2A',
    'imagePath': 'assets/products/eye products/eyebrow/shape and fill pencil.png',
    'imageUrl': '',
  ...
  },
  {
    ...
    'reviews': 99,
    'colorHex': '#7A5530',
    'imagePath': 'assets/products/eye products/eyebrow/volumizing 24h wear brow.png',
    'imageUrl': '',
...

  {
    ...
    'shades': [
      ...
      {'name': 'Soft Black',           'hex': '#1A0A00'},
      {'name': 'Darkest Brown',        'hex': '#2A1000'},
      {'name': 'Dark Brown',           'hex': '#3B1F0A'},
      {'name': 'Medium Brown',         'hex': '#6B4226'},
      {'name': 'Light Brown',          'hex': '#8B6040'},
      {'name': 'Dark Chestnut',        'hex': '#5A2010'},
      {'name': 'Medium Chestnut',      'hex': '#7A3020'},
      {'name': 'Light Chestnut',       'hex': '#9A5030'},
      {'name': 'Dark Auburn',          'hex': '#6A1820'},
      {'name': 'Medium Auburn',        'hex': '#8B2020'},
      {'name': 'Light Auburn',         'hex': '#A83030'},
      {'name': 'Dark Blonde',          'hex': '#B07840'},
      {'name': 'Medium Blonde',        'hex': '#C89050'},
      {'name': 'Light Blonde',         'hex': '#D8B060'},
      {'name': 'Very Light Blonde',    'hex': '#EACE80'},
      {'name': 'Ultra Light Blonde',   'hex': '#F5E090'},
      {'name': 'Platinum Blonde',      'hex': '#F0E8C8'},
      {'name': 'Dark Copper',          'hex': '#8B4010'},
      {'name': 'Medium Copper',        'hex': '#B06030'},
      {'name': 'Light Copper',         'hex': '#D08050'},
    ],
  },

  {
    ...
    'shades': [
      {'name': 'Crimson Red',          'hex': '#C01020'},
      {'name': 'Cherry Bomb',          'hex': '#A00818'},
      {'name': 'Coral Blaze',          'hex': '#E04830'},
      {'name': 'Rose Gold',            'hex': '#D0807A'},
      {'name': 'Dusty Rose',           'hex': '#C87880'},
      {'name': 'Hot Pink',             'hex': '#D02080'},
      {'name': 'Magenta',              'hex': '#B01070'},
      {'name': 'Purple Haze',          'hex': '#6020A0'},
      {'name': 'Ultra Violet',         'hex': '#4010B0'},
      {'name': 'Electric Blue',        'hex': '#0030C0'},
      {'name': 'Teal Storm',           'hex': '#006880'},
      {'name': 'Forest Emerald',       'hex': '#006030'},
      {'name': 'Neon Green',           'hex': '#40C000'},
      {'name': 'Golden Yellow',        'hex': '#D0A000'},
      {'name': 'Sunset Orange',        'hex': '#D04800'},
      {'name': 'Peach Dream',          'hex': '#E09070'},
      {'name': 'Icy Lavender',         'hex': '#B0A0D0'},
      {'name': 'Silver Steel',         'hex': '#9090A8'},
    ],
  },

  {
    ...
    'shades': [
      {'name': 'Clear Shine',          'hex': '#F5EDE0'},
      {'name': 'Cool Platinum',        'hex': '#E0E0F0'},
      {'name': 'Pearl Blonde',         'hex': '#F0E8D0'},
      {'name': 'Champagne',            'hex': '#EDD8A8'},
      {'name': 'Honey Gold',           'hex': '#D4A840'},
      {'name': 'Warm Caramel',         'hex': '#C08840'},
      {'name': 'Chocolate Gloss',      'hex': '#7A4520'},
      {'name': 'Brunette Boost',       'hex': '#5A3018'},
      {'name': 'Cool Ash Brown',       'hex': '#6A6858'},
      {'name': 'Rose Quartz',          'hex': '#E0A8A8'},
...

  {
    ...
    'shades': [
      {'name': 'Warm Black',       'hex': '#1A0800'},
      {'name': 'Mocha Brown',      'hex': '#5A2810'},
      {'name': 'Rich Chestnut',    'hex': '#7A3020'},
      {'name': 'Auburn Spice',     'hex': '#9A3820'},
      {'name': 'Copper Glow',      'hex': '#B05020'},
      {'name': 'Warm Caramel',     'hex': '#C07030'},
      {'name': 'Honey Butter',     'hex': '#D09040'},
      {'name': 'Champagne Blonde', 'hex': '#E0B860'},
      {'name': 'Rose Tint',        'hex': '#D09090'},
      {'name': 'Berry Plum',       'hex': '#602040'},
      {'name': 'Violet Mist',      'hex': '#7050B0'},
      {'name': 'Sapphire Blue',    'hex': '#2040A0'},
      {'name': 'Teal Oasis',       'hex': '#208080'},
      {'name': 'Forest Green',     'hex': '#205020'},
      {'name': 'Silver Mist',      'hex': '#9090A0'},
      {'name': 'Pastel Pink',      'hex': '#E0A0B0'},
    ],
  },

  {
    ...
    'shades': [
      {'name': 'Natural Sun-Kiss',     'hex': '#D4A840'},
      {'name': 'Honey Melt',           'hex': '#C89050'},
      {'name': 'Golden Hour',          'hex': '#DDB840'},
      {'name': 'Caramel Swirl',        'hex': '#B87840'},
      {'name': 'Butter Blonde',        'hex': '#E8CC80'},
      {'name': 'Platinum Streak',      'hex': '#F0E8D0'},
      {'name': 'Icy Blonde',           'hex': '#ECE4C0'},
      {'name': 'Rose Gold Highlight',  'hex': '#D09080'},
      {'name': 'Copper Flash',         'hex': '#C07030'},
      {'name': 'Chestnut Highlight',   'hex': '#8B4020'},
      {'name': 'Balayage Warm Brown',  'hex': '#9A6535'},
      {'name': 'Bronde (Brown+Blonde)','hex': '#B08040'},
      {'name': 'Deep Auburn Streak',   'hex': '#7A2020'},
      {'name': 'Cherry Cola',          'hex': '#602020'},
    ],
  },
];
