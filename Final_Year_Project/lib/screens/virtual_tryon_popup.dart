          ...
          child: Stack(
            ...
            children: [
              Column(
                ...
                children: [
                  // Space for overlay close control (keeps logo vertically centred)
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: OutlinedButton(
                            onPressed: () async {
                              final path = await SelfieCaptureScreen.capture(
                                context,
                              );
...
// ── Brand logo: centred asset in a white squircle (matches marketing lockups) ─
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: _maroon.withValues(alpha: 0.12), width: 1.5),
        boxShadow: [
          BoxShadow(
            color: _maroon.withValues(alpha: 0.14),
            blurRadius: 18,
