            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  const Expanded(
                    child: Text(
                      'Set OPENROUTER_API_KEY in `.env` next to pubspec.yaml (it is bundled '
                      'into the app), or use --dart-define=OPENROUTER_API_KEY=…. '
                      'Stop and run flutter run again after editing.',
